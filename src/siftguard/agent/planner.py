...
from siftguard.agent.models import AgentPhase, AgentPlan, AgentStep, AgentStepStatus
...
DEFAULT_AGENT_OBJECTIVE = "Run the constrained deterministic SIFTGuard workflow."
...
def build_default_agent_plan(case_id: str, *, created_at: str) -> AgentPlan:
    """Build the deterministic SIFTGuard agent plan."""
