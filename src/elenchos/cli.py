...
from elenchos.agent.models import AgentRunStatus
from elenchos.agent.run_case import run_case_output_summary, run_case_workflow
...
from elenchos.policy.paths import validate_output_path
from elenchos.triage import SUPPORTED_EVENT_SELECTION_PROFILES
from elenchos.workflows.correlation import run_correlation_workflow
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="elenchos", description="Elenchos CLI")
    ...
    source_group.add_argument(
        "--source-manifest",
        type=Path,
        help="Use an existing JSON source manifest generated by Elenchos",
    )
    ...
    agent_run_parser = agent_subparsers.add_parser(
        "run",
        help="Run the constrained deterministic Elenchos agent workflow",
    )
    ...
    agent_run_case_parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Prepared case manifest generated by elenchos case prepare",
    )
    agent_run_case_parser.add_argument(
        "--casebook",
        type=Path,
